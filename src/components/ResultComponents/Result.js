...
class Result extends Component {
    ...
    getTabs = () => {
        ...
        this.props.result.expressionOfWork.map(expression => {
            let type = this.capitalizeFirstLetter(`${expression.contentType} (${expression.languageOfExpression})`);
            ...
            <ResultDiv>
                ...
                <TabBarDiv>
                    ...
                    {related !== null && <TabButton 
                        ...
                        id={related.tabTitle} 
                        active={related.tabTitle === this.state.activeTab && this.state.toggled} >{related.tabTitle}</TabButton>}
                </TabBarDiv>
                {this.state.toggled && 
                <DetailContainer>
